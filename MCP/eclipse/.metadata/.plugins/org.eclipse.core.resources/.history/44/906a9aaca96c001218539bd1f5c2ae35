...
public class BaseModTweaks {
	...
	public static CreativeTabs customTab = new CreativeTabTweaks("user2013 Tweaks");
	
	@PreInit
	public void preInit(FMLPreInitializationEvent event) {
		//code run before mod load
		LanguageRegistry.instance().addStringLocalization("itemGroup.customTab", "en_US", "user2013 Tweaks");
	}
